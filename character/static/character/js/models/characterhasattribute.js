...
Models.CharacterHasAttribute = Backbone.Model.extend({
    defaults: {
        id: null,
        character: null,
        trait: null,
    ...
    parse: function (raw) {
        return {
            ...
            trait: Traits.Objects.Attribute.get(parseInt(raw.trait, 10)),
    ...
    url: function () {
        return '/api/character/CharacterHasAttribute/' + (this.id == null ? '' : this.id + '/');
    },
});

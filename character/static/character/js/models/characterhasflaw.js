...
Models.CharacterHasFlaw = Backbone.Model.extend({
    defaults: {
        id: null,
        character: null,
        trait: null,
    ...
    parse: function (raw) {
        return {
            ...
            trait: Traits.Objects.Flaw.get(parseInt(raw.trait, 10)),
    ...
    url: function () {
        return '/api/character/CharacterHasFlaw/' + (this.id == null ? '' : this.id + '/');
    },
});

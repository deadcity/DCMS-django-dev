...
Models.CharacterHasMiscTrait = Backbone.Model.extend({
    defaults: {
        id: null,
        character: null,
        trait: null,
    ...
    parse: function (raw) {
        return {
            ...
            trait: Traits.Objects.MiscTrait.get(parseInt(raw.trait, 10)),
    ...
    url: function () {
        return '/api/character/CharacterHasMiscTrait/' + (this.id == null ? '' : this.id + '/');
    },
});

...
urlpatterns = patterns('',
    url(r'jsenum/(?P<enum_name>\w+).js$',   trait_views.generate_enum,        name = 'js_enum'),
    url(r'jsmodel/(?P<trait_name>\w+).js$', trait_views.generate_trait_model, name = 'js_trait_model'),
    *_urls
)
